...
export const salesData: SalesPerson[] = [
    { branch: "Mumbai", name: "Vishal Ambhore" },
    ...
    { branch: "Ulasnagar", name: "Sachin Bhosale" },
    { branch: "Ulasnagar", name: "Shiv Ratan (Shivam)" },
    { branch: "Ulasnagar", name: "Viay Sutar" },
    { branch: "Kolkata", name: "Vishal Ambhore" },
    { branch: "Kolkata", name: "Rajesh Jain" },
    { branch: "Jaipur", name: "Vishal Ambhore" },
    { branch: "Jaipur", name: "Durgesh Bhati" },
    { branch: "Delhi", name: "Vinay Chhajer" },
